...
public class P250 implements Listener
{
    ...
    private final int bullet_charger = 13; //nombre de balles par chargeur
    private final int max_bullet = 26; //total de munitions
    ...
    private final int wait_for_shoot_delay = 5; //temps d'armement (ticks)
