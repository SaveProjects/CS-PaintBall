package fr.edminecoreteam.cspaintball.content.game.weapons.lourdes;
...
public class NEGEV implements Listener
{
    ...
    private final String refill_sound = "5s"; //Bruit de recharge
                                    ...
                                    public void run() {
                                        ...
                                        if (f == wait_for_shoot_delay)
                                        {
                                            ...
                                            if (core.weaponsMap().getGust().get(p).equalsIgnoreCase("a"))
                                            {
                                                ...
                                                Vector directionSnow = snowball.getVelocity();
                                                directionSnow.setY(directionSnow.getY()  + 0.2);
