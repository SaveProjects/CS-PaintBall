...
public class FAMAS implements Listener
{
    ...
    private final int bullet_charger = 25; //nombre de balles par chargeur
    private final int max_bullet = 90; //total de munitions
    private final Material weapon = Material.WOOD_AXE; //materiel de l'ame
    private final String weapon_name = "FAMAS"; //titre de l'arme
    private final String weapon_id = "famas"; //id de l'arme
    private final int weapon_damage = 7; //dégats de l'arme (en coeurs)
    private final int wait_for_shoot_delay = 3; //temps d'armement (ticks)
